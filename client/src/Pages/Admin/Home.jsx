...
import { getEmployeeList } from '../../Api/AdminApi/AdminRequest'
                                        ...
                                        applicationList?.map((list, index) => {
                                            return (
                                                <tr className='border-b-2'>
                                                    ...
                                                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm whitespace-nowrap py-4 ">{list?.createdAt}</td>
                                                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm whitespace-nowrap py-4 ">
                                                        <button className="mr-3 bg-transparent hover:bg-green-500 text-green-700 font-semibold hover:text-white py-2 px-4 border border-green-500 hover:border-transparent rounded" onClick={() => { fullDetails(list._id) }}>Edit</button>
                                                        <button className="bg-transparent hover:bg-red-500 text-red-700 font-semibold hover:text-white py-2 px-4 border border-red-500 hover:border-transparent rounded" onClick={() => { rejectForm(list?._id) }}>Delete</button>
                                                    </td>
                                                </tr>
                                            )
                                        })
